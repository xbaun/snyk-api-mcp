...
- `python3 .github/skills/snyk-orchestration/scripts/ledger.py select --ledger .synk/{sessionId}/issues-ledger.json --repo-root . --format json`

Optional operator overview:

- `python3 .github/skills/snyk-orchestration/scripts/ledger.py analyze --ledger .synk/{sessionId}/issues-ledger.json --format json`

### Persist `in-progress` before resolver launch

- `python3 .github/skills/snyk-orchestration/scripts/ledger.py set-status --ledger .synk/{sessionId}/issues-ledger.json --key <advisoryKey> --status in-progress`

### Persist validated handback

- `python3 .github/skills/snyk-orchestration/scripts/ledger.py update --ledger .synk/{sessionId}/issues-ledger.json --key <advisoryKey> --from-handback -`
...
- `python3 .github/skills/snyk-orchestration/scripts/ledger.py record-failure --ledger .synk/{sessionId}/issues-ledger.json --key <advisoryKey> --kind <handback-parse|handback-format|resume|other> --error <message>`

### Cascade checks after successful dependency remediation

- `python3 .github/skills/snyk-orchestration/scripts/ledger.py cascade-check --ledger .synk/{sessionId}/issues-ledger.json --package <packageName> --version <targetVersion> --dry-run`
- `python3 .github/skills/snyk-orchestration/scripts/ledger.py cascade-check --ledger .synk/{sessionId}/issues-ledger.json --package <packageName> --version <targetVersion> --apply`
